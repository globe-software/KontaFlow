...
export default function CustomersPage() {
  ...
  // Load customers
  const loadCustomers = async (showSearchIndicator = false) => {
    try {
  ...
  useEffect(() => {
    ...
    if (editId) {
      const customerId = Number(editId);
      // Load the customer to edit
      customersService.getById(customerId).then((response) => {
  ...
  return (
    <MainLayout>
      <div className="container mx-auto py-6 px-6">
        ...
        {!isInitialLoading && <CustomersStats customers={customers} />}
              ...
              <div className="flex items-center gap-2">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="true">{t('customers.filters.active')}</SelectItem>
                    <SelectItem value="false">{t('customers.filters.inactive')}</SelectItem>
                  </SelectContent>
                </Select>
              </div>
            </div>
        ...
        {error && (
          <div className="mb-6 rounded-lg border border-red-200 bg-red-50 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h3 className="font-semibold text-red-900">{t('customers.messages.loadError')}</h3>
            ...
            {pagination.totalPages > 1 && (
              <div className="mt-4 flex items-center justify-between">
                <p className="text-sm text-muted-foreground">
                  {t('pagination.showing')} {customers.length} {t('pagination.of')} {pagination.total} {t('pagination.results')}
                </p>
